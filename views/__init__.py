...
import views.utils_scheduling
import views.utils_support_bundle
import views.fleet
...
router.include_router(views.utils_scheduling.router, prefix="/utils/scheduling")
router.include_router(views.utils_support_bundle.router, prefix="/utils/support-bundle")
