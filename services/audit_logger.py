...
class AuditLogger:
    ...
    def log_auth_success(
        self, username: str, ip_address: str, action: str = "login"
    ) -> None:
        """
    ...
    def log_zfs_operation(
        self, user: str, operation: str, success: bool = True, **kwargs
    ) -> None:
        """
        Log a ZFS operation.
    ...
    def log_pool_checkpoint_create(
        self,
        user: str,
        pool_name: str,
        success: bool = True,
    ...
    def log_pool_checkpoint_discard(
        self,
        user: str,
        pool_name: str,
        success: bool = True,
    ...
    def log_vdev_warning_acknowledge(self, user: str, pool_name: str) -> None:
        ...
        self.log_zfs_operation(
            user=user, operation="vdev_warning_acknowledge", pool=pool_name, success=True
        )

    def log_pool_vdev_add(
        self,
        user: str,
        pool_name: str,
        vdevs: str,
    ...
    def log_dataset_property_change(
        self,
        user: str,
        dataset_name: str,
        property_name: str,
    ...
    def log_shell_session(
        ...
        **details: Any,
        ...
        """Log terminal session metadata without recording commands or output."""
        entry = {
            "user": user,
            "action": action,
        ...
        logger = self.loggers[LogCategory.SHELL]
        if success:
            logger.info(self._format_details(entry))
        else:
            logger.error(self._format_details(entry))
    ...
    def get_all_log_paths(self) -> Dict[str, Path]:
        ...
        """
        return {
            category.value: self.get_log_file_path(category) for category in LogCategory
        }
